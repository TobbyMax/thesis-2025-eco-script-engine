...
# prepare Eco.SEM1
include $(CLEAR_VARS)
LOCAL_MODULE    := lib9BC2C181999243A38E45C2BC67CDDD73
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/lib9BC2C181999243A38E45C2BC67CDDD73.a 
include $(PREBUILT_STATIC_LIBRARY)
########################
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoSEM1.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoSEM1UnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 9BC2C181999243A38E45C2BC67CDDD73
